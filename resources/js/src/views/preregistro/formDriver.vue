    ...
    <b-row>
      ...
      <b-col md="6">
        <b-form-group label="Nombres">
          <b-form-input
              class="mb-2"
              label="Nombres"
              v-model.trim="driver.names_driver">
          </b-form-input>
        </b-form-group>
      </b-col>
      ...
      <b-col md="6">
        <b-form-group label="Apellidos">
          <b-form-input
              class="mb-2"
              label="Nombres"
              v-model.trim="driver.surnames_driver">
          </b-form-input>
        </b-form-group>
      </b-col>
      ...
      <b-col md="6">
        <b-form-group label="Tipo de identificación" label-for="identificacion-type">
          <b-form-select
              v-model="driver.id_type_id_driver"
      ...
      <b-col md="6">
        <b-form-group label="Identificación">
          <b-form-input
              class="mb-2"
              label="Nombres"
              v-model.trim="driver.identification_number_driver">
          </b-form-input>
        </b-form-group>
      </b-col>
      ...
      <b-col md="6">
        <b-form-group label="Departamento" label-for="department">
          <b-form-select
              v-model="driver.department_id_driver"
      ...
      <b-col md="6">
        <b-form-group label="Municipio" label-for="municipalitie">
          <b-form-select
              v-model="driver.municipality_id_driver"
      ...
      <b-col md="6">
        <b-form-group label="Fecha de nacimiento" label-for="date_of_birth">
          <b-form-input id="date_of_birth" v-model="driver.date_of_birth_driver"
                        class="input"
                        type="date">
          </b-form-input>
        </b-form-group>
      ...
      <b-col md="6">
        <b-form-group label="Dirección residencial" label-for="residence_address">
          <b-form-input
              ...
              v-model.trim="driver.residence_address_driver">
          </b-form-input>
        </b-form-group>
      </b-col>
      ...
      <b-col md="6">
        <b-form-group label="Telefono celular" label-for="phone_number">
          <b-form-input
              class="mb-2"
              id="phone_number"
              v-model.trim="driver.phone_number_driver">
          </b-form-input>
        </b-form-group>
      </b-col>
      ...
      <b-col md="12">
        <b-form-group label="Correo electronico" label-for="email">
          <b-form-input
              class="mb-2"
              id="email"
              v-model.trim="driver.email_driver">
          </b-form-input>
        </b-form-group>
      </b-col>
      ...
      <b-col md="6">
        <b-form-group label="Cedula" label-for="email">
          <b-form-file
              v-model="driver.file_cc_driver"
              browse-text="Guardar"
              :state="Boolean(driver.file_cc_driver)"
      ...
      <b-col md="6">
        <b-form-group label="Licencia" label-for="license">
          <b-form-file
              v-model="driver.file_license"
              browse-text="Guardar"
              :state="Boolean(driver.file_license)"
              placeholder="Elija un archivo o suéltelo aquí ... "
              drop-placeholder="Suelta el archivo aquí ...">
          </b-form-file>
        </b-form-group>
