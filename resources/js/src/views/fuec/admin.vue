<template>
  <div class="main-content">
    ...
    <!-- <div role="alert" aria-live="polite" aria-atomic="true" class="alert alert-dismissible alert-alert alert-card alert-info">
...
export default {
  ...
  created() {
    this.getFuecs(this.search).then(response => {
  ...
  methods: {
    ...mapActions('fuec', ['getFuecs', 'updateContract', 'deleteContract']),
