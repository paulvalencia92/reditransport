<template>
  <section>
    ...
    <div class="text-right">
      <router-link class="btn btn-primary" :to="{name:'notas-credito-registrar'}">Registrar nota credito</router-link>
    </div>
...
export default {
  ...
  methods: {
    ...
    ...mapActions('invoices', ['getInvoiceByType', 'emitCreditNote']),
